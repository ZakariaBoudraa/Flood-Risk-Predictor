...
def rolling_features(data):
    ...
    data["PRECTOTCORR_1d_CHANGE"] = data.grouby("CITY")["PRECTOTCORR"].diff()
    data["SM_ROOTZONE_1d_CHANGE"] = data.grouby("CITY")["SM_ROOTZONE"].diff()
    data["SM_SURFACE_1d_CHANGE"] = data.grouby("CITY")["SM_SURFACE"].diff()
